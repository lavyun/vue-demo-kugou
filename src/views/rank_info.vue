  ...
  export default {
    ...
    methods:{
      ...
      parseList(data){
        ...
        this.$store.commit('setRankTitle',this.title);
...
<style>
  .rank-list-good{display: inline-block;padding: 2px 8px;left: 12px !important;border-radius: 8px;color: #fff}
